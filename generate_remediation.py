...
This script generates remediation JSON files that can be fed to STIG Assessor
...
Version: 1.0.0
Compatible with: STIG Assessor Complete 8.0.0+
"""
...
def interactive_mode():
    ...
    print("This tool generates JSON files for STIG Assessor --apply-results\n")
...
def main():
    parser = argparse.ArgumentParser(
        description="Generate remediation JSON files for STIG Assessor",
