...
<CHECKLIST>
    ...
    def test_export_poam(self):
        ...
        self.assertIn(
            "Control Number,Vulnerability Description,Severity,Status,Comments,Checklist Name",
            csv_str,
        )
        ...
        self.assertIn(
            "V-3,Rule 3 low test,LOW,Not_Reviewed,,test_poam_bulk.ckl", csv_str
        )
    ...
    def test_bulk_edit_severity(self):
        ...
        for vuln in root.findall(".//VULN"):
            for sd in vuln.findall("STIG_DATA"):
                if (
                    sd.findtext("VULN_ATTRIBUTE") == "Vuln_Num"
                    and sd.findtext("ATTRIBUTE_DATA") == "V-3"
                ):
    ...
    def test_bulk_edit_regex(self):
        ...
        for vuln in root.findall(".//VULN"):
            for sd in vuln.findall("STIG_DATA"):
                if (
                    sd.findtext("VULN_ATTRIBUTE") == "Vuln_Num"
                    and sd.findtext("ATTRIBUTE_DATA") == "V-1"
                ):
